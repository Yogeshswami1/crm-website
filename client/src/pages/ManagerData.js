...
const ManagerData = () => {
  ...
  const handleManagerSelect = (managerId) => {
    ...
    axios
      .get(`${apiUrl}/api/managers/getcontact/${manager._id}`)
      .then((response) => {
  ...
  return (
    <Layout
      ...
      style={{ minHeight: "100vh", overflow: "auto", marginLeft: "2rem" }}
    >
      <Header
        className="manager-header"
        style={{
          backgroundImage:
            "linear-gradient(90deg, #FC6076, #FF9A44, #EF9D43, #E75516)",
          padding: "0 20px",
        }}
      >
        <h1
      ...
      >
        {loading ? (
          ...
          >
            <p>
              <strong>Position:</strong> {selectedManager.position}
            </p>
            <p>
              <strong>Status:</strong> {selectedManager.status}
            </p>
            <p>
              <strong>Service:</strong> {selectedManager.service}
            </p>
            <p>
            ...
            <p>
              ...
              {new Date(selectedManager.dateOfJoining).toLocaleDateString()}
            </p>
            <p>
          ...
          <div style={{ textAlign: "center", marginTop: "50px" }}>
            Please select a manager to see the details.
          </div>
        )}
      </Content>
    </Layout>
