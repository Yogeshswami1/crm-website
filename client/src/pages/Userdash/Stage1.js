  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <VerticalTimeline>
        ...
        {userData?.payment?.stage1 && (
          <VerticalTimelineElement
            date={`Payment Status: ${userData?.payment?.stage1?.status}`}
          ...
          >
            ...
            <p><strong>Amount:</strong> {userData?.payment?.stage1?.amount}</p>
            <p><strong>Payment Mode:</strong> {userData?.payment?.stage1?.paymentMode}</p>
        ...
        {userData && (
          ...
          >
            ...
            <p><strong>Legality:</strong> {userData?.legality}</p>
            <p><strong>Legality Link:</strong> <a href={userData?.legalityLink} target="_blank" rel="noopener noreferrer">View Document</a></p>
        ...
        {userData?.ovc && (
          ...
          >
            ...
            <p><strong>OVC:</strong> {userData?.ovc}</p>
        ...
        {userData?.idCard && (
          ...
          >
            ...
            <p><strong>ID Card:</strong> {userData?.idCard}</p>
        ...
        {userData?.theme && (
          <VerticalTimelineElement
            date={`Theme Status: ${userData?.theme || 'Pending'}`}
            icon={getIcon(userData?.theme)}
            iconStyle={{ background: 'white', color: '#fff', boxShadow: '0 3px 5px rgba(0,0,0,0.2)' }}
            contentStyle={getContentStyle(userData?.theme)}
            contentArrowStyle={{ borderRight: '7px solid  #f9f9f9' }}
            dateStyle={{ color: '#999', fontSize: '14px' }}
          >
        ...
        {userData?.stage1Completion && (
          ...
          >
            ...
            <p><strong>Stage 1 Completion:</strong> {userData?.stage1Completion}</p>
