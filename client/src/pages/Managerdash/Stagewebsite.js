...
//           message.error(`Error: ${error.response.data.message || "Failed to fetch data"}`);
...
//     } catch (error) {
//       message.error("Failed to update legality details");
//     }
//   };
...
//         {currentRecord && (
//           <>
//             <p><strong>Name:</strong> {currentRecord.name || 'N/A'}</p>
//             <p><strong>Email:</strong> {currentRecord.email || 'N/A'}</p>
//             <p><strong>Primary Contact:</strong> {maskContact(currentRecord.primaryContact)}</p>
//             <p><strong>Secondary Contact:</strong> {maskContact(currentRecord.secondaryContact)}</p>
//           </>
//         )}
//       </Modal>
