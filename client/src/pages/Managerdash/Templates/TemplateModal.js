...
//   const [managerName, setManagerName] = useState(''); // State to store manager's name

//   // Fetch the manager's name from localStorage or API
//   useEffect(() => {
//     const managerId = localStorage.getItem('managerId');

//     // Assuming the manager's name is also stored in localStorage for simplicity
//     const storedManagerName = localStorage.getItem('managerName');

//     if (storedManagerName) {
//       setManagerName(storedManagerName); // Use name from localStorage
//     } else if (managerId) {
//       // If the name isn't in localStorage, make an API call to fetch it
//       const fetchManagerName = async () => {
//         try {
//           const response = await axios.get(`${apiUrl}/api/managers/${managerId}`);
//           if (response.status === 200 && response.data) {
//             setManagerName(response.data.name); // Assume response contains manager's name
//             localStorage.setItem('managerName', response.data.name); // Store the name for future use
//           }
//         } catch (error) {
...
//         placeholders = [managerName]; // Use the manager's name
//       } else if (templateName === 'id_card') {
//         placeholders = ['good']; // Example placeholder
//       }
...
//         1_message
//       </Button>
//       <Button onClick={() => handleSendTemplate('client_information_form')} style={{ margin: '10px' }}>
//         client_information_form
//       </Button>
//       <Button onClick={() => handleSendTemplate('id_card')} style={{ margin: '10px' }}>
//         id_card
//       </Button>
